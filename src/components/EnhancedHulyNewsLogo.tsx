...
interface EnhancedHulyNewsLogoProps {
  className?: string;
  variant?: 'full' | 'icon' | 'text' | 'animated' | 'minimal';
  showTagline?: boolean;
...
export default function EnhancedHulyNewsLogo({ 
      ...
      <div className={`${className} relative group`}>
        <svg viewBox="0 0 120 120" className="w-full h-full">
          ...
          <g transform="translate(75, 45)">
            ...
            <rect x="0" y="20" width="4" height="15" fill="url(#chartGradient)">
            ...
            <rect x="6" y="15" width="4" height="20" fill="url(#chartGradient)">
            ...
            <rect x="12" y="10" width="4" height="25" fill="url(#chartGradient)">
            ...
            <rect x="18" y="5" width="4" height="30" fill="url(#chartGradient)">
            ...
            <rect x="24" y="8" width="4" height="27" fill="url(#chartGradient)">
    ...
    return (
      <div className={`${className} flex items-center gap-2`}>
        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-400 -mt-1">News</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`${className} flex items-center gap-3`}>
      <div className="w-12 h-12 relative group">
        <svg viewBox="0 0 64 64" className="w-full h-full">
          ...
          <g transform="translate(45, 35)">
            <rect x="0" y="8" width="3" height="12" fill="url(#enhancedChartGradient)" />
            <rect x="4" y="6" width="3" height="14" fill="url(#enhancedChartGradient)" />
            <rect x="8" y="4" width="3" height="16" fill="url(#enhancedChartGradient)" />
            <rect x="12" y="2" width="3" height="18" fill="url(#enhancedChartGradient)" />
          </g>
      ...
      <div className="flex flex-col">
        <h1 className="text-xl font-bold bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent">
          Huly News
        </h1>
        {showTagline && (
